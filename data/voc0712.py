...
# VOC_ROOT = r'D:\ly\yolov_myself\new-YOLOv1_PyTorch-master\VOCdevkit'
# VOC_ROOT = r'‪D:\\ly\\yolov_myself\\VOCdevkit\\'
...
class VOCDetection(data.Dataset):
    ...
    def pull_item(self, index):
        ...
        # 返回值,第一项指向图像数据转化为torch后的数据(用于训练数据),target指向bbox和labels,height和width指向原始图像的高和宽
